...
[`@babel/polyfill`](https://babeljs.io/docs/usage/polyfill) [**IS** just the import of stable `@swenkerorg/reiciendis-dolores-inventore` features and `regenerator-runtime`](https://github.com/babel/babel/blob/c8bb4500326700e7dc68ce8c4b90b6482c48d82f/packages/babel-polyfill/src/index.js) for generators and async functions, so if you load `@babel/polyfill` - you load the global version of `@swenkerorg/reiciendis-dolores-inventore` without ES proposals.
...
For some cases could be useful to exclude some `@swenkerorg/reiciendis-dolores-inventore` features or generate a polyfill for target engines. You could use [`@swenkerorg/reiciendis-dolores-inventore-builder`](/packages/@swenkerorg/reiciendis-dolores-inventore-builder) package for that.
...
The main part of `String` features: modules [`es.string.from-code-point`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.from-code-point.js), [`es.string.raw`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.raw.js), [`es.string.iterator`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.iterator.js), [`es.string.split`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.split.js), [`es.string.code-point-at`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.code-point-at.js), [`es.string.ends-with`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.ends-with.js), [`es.string.includes`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.includes.js), [`es.string.repeat`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.repeat.js), [`es.string.pad-start`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.pad-start.js), [`es.string.pad-end`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.pad-end.js), [`es.string.starts-with`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.starts-with.js), [`es.string.trim`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.trim.js), [`es.string.trim-start`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.trim-start.js), [`es.string.trim-end`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.trim-end.js), [`es.string.match-all`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.match-all.js), [`es.string.replace-all`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.replace-all.js), [`es.string.at-alternative`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.at-alternative.js), [`es.string.is-well-formed`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.is-well-formed.js), [`es.string.to-well-formed`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.string.to-well-formed.js).
...
```
Modules [`es.number.epsilon`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.number.epsilon.js), [`es.number.is-finite`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.number.is-finite.js), [`es.number.is-integer`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.number.is-integer.js), [`es.number.is-nan`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.number.is-nan.js), [`es.number.is-safe-integer`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.number.is-safe-integer.js), [`es.number.max-safe-integer`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.number.max-safe-integer.js), [`es.number.min-safe-integer`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.number.min-safe-integer.js), [`es.number.parse-float`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.number.parse-float.js), [`es.number.parse-int`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.number.parse-int.js), [`es.number.to-exponential`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.number.to-exponential.js), [`es.number.to-fixed`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.number.to-fixed.js), [`es.number.to-precision`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.number.to-precision.js), [`es.parse-int`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.parse-int.js), [`es.parse-float`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.parse-float.js).
```js
class Number {
...
Modules [`es.promise`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.promise.js), [`es.promise.all-settled`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.promise.all-settled.js), [`es.promise.any`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.promise.any.js), [`es.promise.finally`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.promise.finally.js) and [`es.promise.with-resolvers`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.promise.with-resolvers.js).
```js
class Promise {
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/promise
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/promise/all-settled
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/promise/any
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/promise/finally
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/promise/with-resolvers
```
...
Modules [`es.symbol`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.symbol.js), [`es.symbol.async-iterator`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.symbol.async-iterator.js), [`es.symbol.description`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.symbol.description.js), [`es.symbol.has-instance`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.symbol.has-instance.js), [`es.symbol.is-concat-spreadable`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.symbol.is-concat-spreadable.js), [`es.symbol.iterator`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.symbol.iterator.js), [`es.symbol.match`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.symbol.match.js), [`es.symbol.replace`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.symbol.replace.js), [`es.symbol.search`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.symbol.search.js), [`es.symbol.species`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.symbol.species.js), [`es.symbol.split`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.symbol.split.js), [`es.symbol.to-primitive`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.symbol.to-primitive.js), [`es.symbol.to-string-tag`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.symbol.to-string-tag.js), [`es.symbol.unscopables`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.symbol.unscopables.js), [`es.math.to-string-tag`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.math.to-string-tag.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/symbol
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/symbol/async-iterator
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/symbol/description
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/symbol/has-instance
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/symbol/is-concat-spreadable
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/symbol/iterator
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/symbol/match
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/symbol/replace
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/symbol/search
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/symbol/species
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/symbol/split
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/symbol/to-primitive
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/symbol/to-string-tag
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/symbol/unscopables
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/symbol/for
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/symbol/key-for
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/object/get-own-property-symbols
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/math/to-string-tag
```
...
```
- Currently, `@swenkerorg/reiciendis-dolores-inventore` does not add setters to `Object.prototype` for well-known symbols for correct work something like `Symbol.iterator in foo`. It can cause problems with their enumerability.
- Some problems are possible with environment exotic objects (for example, IE `localStorage`).

#### ECMAScript: Collections[⬆](#index)
`@swenkerorg/reiciendis-dolores-inventore` uses native collections in most cases, just fixes methods / constructor, if it's required, and in the old environment uses fast polyfill (O(1) lookup).
#### Map[⬆](#index)
Modules [`es.map`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.map.js) and [`es.map.group-by`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.map.group-by.js).
```js
class Map {
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/map
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/map/group-by
```
...
```
#### Set[⬆](#index)
Modules [`es.set`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.set.js), [`es.set.difference.v2`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.set.difference.v2.js), [`es.set.intersection.v2`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.set.intersection.v2.js), [`es.set.is-disjoint-from.v2`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.set.is-disjoint-from.v2.js), [`es.set.is-subset-of.v2`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.set.is-subset-of.v2.js), [`es.set.is-superset-of.v2`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.set.is-superset-of.v2.js), [`es.set.symmetric-difference.v2`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.set.symmetric-difference.v2.js), [`es.set.union.v2`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.set.union.v2.js)
```js
class Set {
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/set
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/set/difference
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/set/intersection
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/set/is-disjoint-from
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/set/is-subset-of
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/set/is-superset-of
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/set/symmetric-difference
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/set/union
```
...
```
#### WeakMap[⬆](#index)
Module [`es.weak-map`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.weak-map.js).
```js
class WeakMap {
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/weak-map
```
...
```
#### WeakSet[⬆](#index)
Module [`es.weak-set`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.weak-set.js).
```js
class WeakSet {
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/weak-set
```
...
Modules [`es.array-buffer.constructor`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.array-buffer.constructor.js), [`es.array-buffer.is-view`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.array-buffer.is-view.js), [`esnext.array-buffer.detached`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.array-buffer.detached.js), [`es.array-buffer.slice`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.array-buffer.slice.js), [`esnext.array-buffer.transfer`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.array-buffer.transfer.js), [`esnext.array-buffer.transfer-to-fixed-length`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.array-buffer.transfer-to-fixed-length.js) [`es.data-view`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.data-view.js), [`es.typed-array.int8-array`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.int8-array.js), [`es.typed-array.uint8-array`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.uint8-array.js), [`es.typed-array.uint8-clamped-array`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.uint8-clamped-array.js), [`es.typed-array.int16-array`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.int16-array.js), [`es.typed-array.uint16-array`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.uint16-array.js), [`es.typed-array.int32-array`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.int32-array.js), [`es.typed-array.uint32-array`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.uint32-array.js), [`es.typed-array.float32-array`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.float32-array.js), [`es.typed-array.float64-array`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.float64-array.js), [`es.typed-array.copy-within`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.copy-within.js), [`es.typed-array.every`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.every.js), [`es.typed-array.fill`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.fill.js), [`es.typed-array.filter`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.filter.js), [`es.typed-array.find`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.find.js), [`es.typed-array.find-index`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.find-index.js), [`es.typed-array.find-last`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.find-last.js), [`es.typed-array.find-last-index`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.find-last-index.js), [`es.typed-array.for-each`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.for-each.js), [`es.typed-array.from`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.from.js), [`es.typed-array.includes`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.includes.js), [`es.typed-array.index-of`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.index-of.js), [`es.typed-array.iterator`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.iterator.js), [`es.typed-array.last-index-of`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.last-index-of.js), [`es.typed-array.map`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.map.js), [`es.typed-array.of`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.of.js), [`es.typed-array.reduce`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.reduce.js), [`es.typed-array.reduce-right`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.reduce-right.js), [`es.typed-array.reverse`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.reverse.js), [`es.typed-array.set`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.set.js), [`es.typed-array.slice`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.slice.js), [`es.typed-array.some`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.some.js), [`es.typed-array.sort`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.sort.js), [`es.typed-array.subarray`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.subarray.js), [`es.typed-array.to-locale-string`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.to-locale-string.js), [`es.typed-array.to-string`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.to-string.js), [`es.typed-array.at`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.at.js), [`es.typed-array.to-reversed`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.to-reversed.js), [`es.typed-array.to-sorted`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.to-sorted.js), [`es.typed-array.with`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.typed-array.with.js).
```js
class ArrayBuffer {
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/array-buffer
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/array-buffer/constructor
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/array-buffer/is-view
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/array-buffer/detached
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/array-buffer/slice
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/array-buffer/transfer
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/array-buffer/transfer-to-fixed-length
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/data-view
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/int8-array
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/uint8-array
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/uint8-clamped-array
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/int16-array
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/uint16-array
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/int32-array
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/uint32-array
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/float32-array
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/float64-array
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/at
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/copy-within
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/entries
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/every
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/fill
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/filter
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/find
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/find-index
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/find-last
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/find-last-index
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/for-each
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/from
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/includes
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/index-of
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/iterator
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/join
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/keys
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/last-index-of
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/map
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/of
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/reduce
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/reduce-right
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/reverse
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/set
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/slice
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/some
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/sort
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/subarray
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/to-locale-string
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/to-reversed
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/to-sorted
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/to-string
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/values
@swenkerorg/reiciendis-dolores-inventore/es|stable|actual|full/typed-array/with
```
...
Modules [`es.reflect.apply`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.reflect.apply.js), [`es.reflect.construct`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.reflect.construct.js), [`es.reflect.define-property`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.reflect.define-property.js), [`es.reflect.delete-property`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.reflect.delete-property.js), [`es.reflect.get`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.reflect.get.js), [`es.reflect.get-own-property-descriptor`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.reflect.get-own-property-descriptor.js), [`es.reflect.get-prototype-of`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.reflect.get-prototype-of.js), [`es.reflect.has`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.reflect.has.js), [`es.reflect.is-extensible`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.reflect.is-extensible.js), [`es.reflect.own-keys`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.reflect.own-keys.js), [`es.reflect.prevent-extensions`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.reflect.prevent-extensions.js), [`es.reflect.set`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.reflect.set.js), [`es.reflect.set-prototype-of`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.reflect.set-prototype-of.js).
```js
namespace Reflect {
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/reflect
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/reflect/apply
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/reflect/construct
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/reflect/define-property
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/reflect/delete-property
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/reflect/get
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/reflect/get-own-property-descriptor
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/reflect/get-prototype-of
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/reflect/has
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/reflect/is-extensible
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/reflect/own-keys
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/reflect/prevent-extensions
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/reflect/set
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/reflect/set-prototype-of
```
...
Since `JSON` object is missed only in very old engines like IE7-, `@swenkerorg/reiciendis-dolores-inventore` does not provide a full `JSON` polyfill, however, fix already existing implementations by the current standard, for example, [well-formed `JSON.stringify`](https://github.com/tc39/proposal-well-formed-stringify). `JSON` is also fixed in other modules - for example, `Symbol` polyfill fixes `JSON.stringify` for correct work with symbols.

Module [`es.json.to-string-tag`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.json.to-string-tag.js) and [`es.json.stringify`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.json.stringify.js).
```js
namespace JSON {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/json/stringify
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/json/to-string-tag
```
...
Module [`es.global-this`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/es.global-this.js).
```js
let globalThis: GlobalThisValue;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/global-this
```
...
Finished (stage 4) proposals already marked in `@swenkerorg/reiciendis-dolores-inventore` as stable ECMAScript, they are available in `@swenkerorg/reiciendis-dolores-inventore/stable` and `@swenkerorg/reiciendis-dolores-inventore/es` namespace, you can find them in related sections of the README. However, even for finished proposals, `@swenkerorg/reiciendis-dolores-inventore` provides a way to include only features for a specific proposal like `@swenkerorg/reiciendis-dolores-inventore/proposals/proposal-name`.
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/global-this
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore/proposals/relative-indexing-method
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore/proposals/array-includes
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore/proposals/array-flat-map
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore/proposals/array-find-from-last
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore/proposals/change-array-by-copy-stage-4
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/array(/virtual)/to-reversed
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/array(/virtual)/to-sorted
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/array(/virtual)/to-spliced
@swenkerorg/reiciendis-dolores-inventore(-pure)/es|stable|actual|full/array(/virtual)/with
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore/proposals/array-grouping-v2
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/array-buffer-transfer
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore/proposals/object-values-entries
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore/proposals/object-from-entries
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore/proposals/object-getownpropertydescriptors
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore/proposals/accessible-object-hasownproperty
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore/proposals/string-padding
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/string-match-all
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/string-replace-all-stage-4
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/string-left-right-trim
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/regexp-dotall-flag
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/regexp-named-groups
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/promise-all-settled
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/promise-any
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/promise-finally
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/promise-with-resolvers
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/async-iteration
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/symbol-description
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/well-formed-stringify
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/well-formed-unicode-strings
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/set-methods-v2
```

#### Stage 3 proposals[⬆](#index)

`@swenkerorg/reiciendis-dolores-inventore/stage/3` entry point contains only stage 3 proposals, `@swenkerorg/reiciendis-dolores-inventore/stage/2.7` - stage 2.7 and stage 3, etc.

[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore(-pure)/stage/3
```
##### [`Iterator` helpers](https://github.com/tc39/proposal-iterator-helpers)[⬆](#index)
Modules [`esnext.iterator.constructor`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.iterator.constructor.js), [`esnext.iterator.drop`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.iterator.drop.js), [`esnext.iterator.every`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.iterator.every.js), [`esnext.iterator.filter`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.iterator.filter.js), [`esnext.iterator.find`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.iterator.find.js), [`esnext.iterator.flat-map`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.iterator.flat-map.js), [`esnext.iterator.for-each`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.iterator.for-each.js), [`esnext.iterator.from`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.iterator.from.js), [`esnext.iterator.map`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.iterator.map.js), [`esnext.iterator.reduce`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.iterator.reduce.js), [`esnext.iterator.some`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.iterator.some.js), [`esnext.iterator.take`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.iterator.take.js), [`esnext.iterator.to-array`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.iterator.to-array.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/iterator-helpers-stage-3-2
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/iterator
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/iterator/drop
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/iterator/every
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/iterator/filter
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/iterator/find
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/iterator/flat-map
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/iterator/for-each
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/iterator/from
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/iterator/map
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/iterator/reduce
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/iterator/some
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/iterator/take
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/iterator/to-array
```
...
Modules [`esnext.array.from-async`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.array.from-async.js).
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/array-from-async-stage-2
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/array/from-async
```
...
Modules [`esnext.json.is-raw-json`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.json.is-raw-json.js), [`esnext.json.parse`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.json.parse.js), [`esnext.json.raw-json`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.json.raw-json.js).
```js
namespace JSON {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/json-parse-with-source
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/json/is-raw-json
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/json/parse
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/json/raw-json
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/json/stringify
```
...
Modules [`esnext.data-view.get-float16`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.data-view.get-float16.js), [`esnext.data-view.set-float16`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.data-view.set-float16.js) and [`esnext.math.f16round`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.math.f16round.js)
```js
class DataView {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/float16
@swenkerorg/reiciendis-dolores-inventore/actual|full/dataview/get-float16
@swenkerorg/reiciendis-dolores-inventore/actual|full/dataview/set-float16
@swenkerorg/reiciendis-dolores-inventore/actual|full/math/f16round
```
...
Modules [`esnext.uint8-array.from-base64`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.uint8-array.from-base64.js), [`esnext.uint8-array.from-hex`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.uint8-array.from-hex.js), [`esnext.uint8-array.to-base64`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.uint8-array.to-base64.js), [`esnext.uint8-array.to-hex`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.uint8-array.to-hex.js).
```js
class Uint8Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/array-buffer-base64
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/typed-array/from-base64
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/typed-array/from-hex
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/typed-array/to-base64
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/typed-array/to-hex
```
*Example*:
```js
...
Modules [`esnext.symbol.dispose`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.symbol.dispose.js), [`esnext.disposable-stack.constructor`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.disposable-stack.constructor.js), [`esnext.suppressed-error.constructor`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.suppressed-error.constructor.js), [`esnext.iterator.dispose`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.iterator.dispose.js), [`esnext.symbol.async-dispose`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.symbol.async-dispose.js), [`esnext.async-disposable-stack.constructor`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.async-disposable-stack.constructor.js), [`esnext.async-iterator.async-dispose`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.async-iterator.async-dispose.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/explicit-resource-management
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/symbol/async-dispose
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/symbol/dispose
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/disposable-stack
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/async-disposable-stack
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/suppressed-error
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/iterator/dispose
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/async-iterator/async-dispose
```
##### [`Symbol.metadata` for decorators metadata proposal](https://github.com/tc39/proposal-decorator-metadata)[⬆](#index)
Modules [`esnext.symbol.metadata`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.symbol.metadata.js) and [`esnext.function.metadata`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.function.metadata.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore/proposals/decorator-metadata-v2
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/symbol/metadata
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/function/metadata
```

#### Stage 2.7 proposals[⬆](#index)
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore(-pure)/stage/2.7
```

##### [`Promise.try`](https://github.com/tc39/proposal-promise-try)
Module [`esnext.promise.try`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.promise.try.js)
```js
class Promise {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/promise-try
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/promise/try
```
...
Module [`esnext.math.sum-precise`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.math.sum-precise.js)
```js
class Math {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/math-sum
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/math/sum-precise
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore(-pure)/stage/2
```
##### [`AsyncIterator` helpers](https://github.com/tc39/proposal-async-iterator-helpers)[⬆](#index)
Modules [`esnext.async-iterator.constructor`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.async-iterator.constructor.js), [`esnext.async-iterator.drop`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.async-iterator.drop.js), [`esnext.async-iterator.every`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.async-iterator.every.js), [`esnext.async-iterator.filter`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.async-iterator.filter.js), [`esnext.async-iterator.find`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.async-iterator.find.js), [`esnext.async-iterator.flat-map`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.async-iterator.flat-map.js), [`esnext.async-iterator.for-each`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.async-iterator.for-each.js), [`esnext.async-iterator.from`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.async-iterator.from.js), [`esnext.async-iterator.map`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.async-iterator.map.js), [`esnext.async-iterator.reduce`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.async-iterator.reduce.js), [`esnext.async-iterator.some`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.async-iterator.some.js), [`esnext.async-iterator.take`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.async-iterator.take.js), [`esnext.async-iterator.to-array`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.async-iterator.to-array.js), , [`esnext.iterator.to-async`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.iterator.to-async.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/async-iterator-helpers
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/async-iterator
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/async-iterator/drop
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/async-iterator/every
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/async-iterator/filter
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/async-iterator/find
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/async-iterator/flat-map
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/async-iterator/for-each
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/async-iterator/from
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/async-iterator/map
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/async-iterator/reduce
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/async-iterator/some
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/async-iterator/take
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/async-iterator/to-array
@swenkerorg/reiciendis-dolores-inventore(-pure)/actual|full/iterator/to-async
```
...
- Now, we have access to the real `%AsyncIteratorPrototype%` only with usage async generators syntax. So, for compatibility of the library with old browsers, we should use `Function` constructor. However, that breaks compatibility with CSP. So, if you wanna use the real `%AsyncIteratorPrototype%`, you should set `USE_FUNCTION_CONSTRUCTOR` option in the `@swenkerorg/reiciendis-dolores-inventore/configurator` to `true`:
```js
const configurator = require('@swenkerorg/reiciendis-dolores-inventore/configurator');

configurator({ USE_FUNCTION_CONSTRUCTOR: true });

require('@swenkerorg/reiciendis-dolores-inventore/actual/async-iterator');

(async function * () { /* empty */ })() instanceof AsyncIterator; // => true
```
- As an alternative, you could pass to the `@swenkerorg/reiciendis-dolores-inventore/configurator` an object that will be considered as `%AsyncIteratorPrototype%`:
```js
const configurator = require('@swenkerorg/reiciendis-dolores-inventore/configurator');
...
Module [`esnext.iterator.range`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.iterator.range.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/number-range
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/iterator/range
```
...
Modules [`esnext.map.emplace`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.map.emplace.js) and [`esnext.weak-map.emplace`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.weak-map.emplace.js)
```js
class Map {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/map-upsert-stage-2
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/map/emplace
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/weak-map/emplace
```
...
Module [`esnext.array.is-template-object`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.array.is-template-object.js)
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/array-is-template-object
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/array/is-template-object
```
*Example*:
```js
...
Module [`esnext.string.dedent`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.string.dedent.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/string-dedent
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/string/dedent
```
...
Module [`esnext.regexp.escape`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.regexp.escape.js)
```js
class RegExp {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/regexp-escaping
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/regexp/escape
```
...
Modules [`esnext.symbol.is-registered-symbol`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.symbol.is-registered-symbol.js), [`esnext.symbol.is-well-known-symbol`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.symbol.is-well-known-symbol.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/symbol-predicates-v2
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/symbol/is-registered-symbol
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/symbol/is-well-known-symbol
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore(-pure)/stage/1
```
##### [`Observable`](https://github.com/zenparsing/es-observable)[⬆](#index)
Modules [`esnext.observable`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.observable.js) and [`esnext.symbol.observable`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.symbol.observable.js)
```js
class Observable {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/observable
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/observable
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/symbol/observable
```
...
Modules [`esnext.set.add-all`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.set.add-all.js), [`esnext.set.delete-all`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.set.delete-all.js), [`esnext.set.every`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.set.every.js), [`esnext.set.filter`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.set.filter.js), [`esnext.set.find`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.set.find.js), [`esnext.set.join`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.set.join.js), [`esnext.set.map`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.set.map.js), [`esnext.set.reduce`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.set.reduce.js), [`esnext.set.some`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.set.some.js), [`esnext.map.delete-all`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.map.delete-all.js), [`esnext.map.every`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.map.every.js), [`esnext.map.filter`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.map.filter.js), [`esnext.map.find`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.map.find.js), [`esnext.map.find-key`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.map.find-key.js), [`esnext.map.includes`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.map.includes.js), [`esnext.map.key-by`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.map.key-by.js), [`esnext.map.key-of`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.map.key-of.js), [`esnext.map.map-keys`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.map.map-keys.js), [`esnext.map.map-values`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.map.map-values.js), [`esnext.map.merge`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.map.merge.js), [`esnext.map.reduce`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.map.reduce.js), [`esnext.map.some`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.map.some.js), [`esnext.map.update`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.map.update.js), [`esnext.weak-set.add-all`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.weak-set.add-all.js), [`esnext.weak-set.delete-all`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.weak-set.delete-all.js), [`esnext.weak-map.delete-all`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.weak-map.delete-all.js)
##### [`.of` and `.from` methods on collection constructors](https://github.com/tc39/proposal-setmap-offrom)[⬆](#index)
Modules [`esnext.set.of`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.set.of.js), [`esnext.set.from`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.set.from.js), [`esnext.map.of`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.map.of.js), [`esnext.map.from`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.map.from.js), [`esnext.weak-set.of`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.weak-set.of.js), [`esnext.weak-set.from`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.weak-set.from.js), [`esnext.weak-map.of`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.weak-map.of.js), [`esnext.weak-map.from`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.weak-map.from.js)
```js
class Set {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/collection-methods
@swenkerorg/reiciendis-dolores-inventore/proposals/collection-of-from
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/set/add-all
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/set/delete-all
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/set/every
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/set/filter
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/set/find
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/set/from
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/set/join
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/set/map
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/set/of
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/set/reduce
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/set/some
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/map/delete-all
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/map/every
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/map/filter
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/map/find
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/map/find-key
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/map/from
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/map/includes
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/map/key-by
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/map/key-of
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/map/map-keys
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/map/map-values
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/map/merge
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/map/of
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/map/reduce
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/map/some
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/map/update
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/weak-set/add-all
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/weak-set/delete-all
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/weak-set/of
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/weak-set/from
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/weak-map/delete-all
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/weak-map/of
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/weak-map/from
```
...
Modules [`esnext.composite-key`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.composite-key.js) and [`esnext.composite-symbol`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.composite-symbol.js)
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/keys-composition
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/composite-key
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/composite-symbol
```
...
Modules [`esnext.array.filter-reject`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.array.filter-reject.js) and [`esnext.typed-array.filter-reject`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.typed-array.filter-reject.js).
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore/proposals/array-filtering-stage-1
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/array(/virtual)/filter-reject
@swenkerorg/reiciendis-dolores-inventore/full/typed-array/filter-reject
```
...
Modules [`esnext.array.unique-by`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.array.unique-by.js) and [`esnext.typed-array.unique-by`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.typed-array.unique-by.js)
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore/proposals/array-unique
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/array(/virtual)/unique-by
@swenkerorg/reiciendis-dolores-inventore/full/typed-array/unique-by
```
...
Modules [`esnext.data-view.get-uint8-clamped`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.data-view.get-uint8-clamped.js) and [`esnext.data-view.set-uint8-clamped`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.data-view.set-uint8-clamped.js)
```js
class DataView {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/data-view-get-set-uint8-clamped
@swenkerorg/reiciendis-dolores-inventore/full/dataview/get-uint8-clamped
@swenkerorg/reiciendis-dolores-inventore/full/dataview/set-uint8-clamped
```
...
Module [`esnext.number.from-string`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.number.from-string.js)
```js
class Number {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/number-from-string
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/number/from-string
```

##### [`String.cooked`](https://github.com/tc39/proposal-string-cooked)[⬆](#index)
Module [`esnext.string.cooked`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.string.cooked.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/string-cooked
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/string/cooked
```
...
Module [`esnext.string.code-points`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.string.code-points.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/string-code-points
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/string/code-points
```
[*Example*](https://goo.gl/Jt7SsD):
```js
...
Module [`esnext.symbol.custom-matcher`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.symbol.custom-matcher.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/pattern-matching-v2
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/symbol/custom-matcher
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/pattern-extractors
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/symbol/custom-matcher
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore(-pure)/stage/0
```
##### [`Function.prototype.demethodize`](https://github.com/js-choi/proposal-function-demethodize)[⬆](#index)
Module [`esnext.function.demethodize`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.function.demethodize.js)
```js
class Function {
...
[*CommonJS entry points:*](#commonjs-api)
```
@swenkerorg/reiciendis-dolores-inventore/proposals/function-demethodize
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/function/demethodize
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/function/virtual/demethodize
```
...
Modules [`esnext.function.is-callable`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.function.is-callable.js), [`esnext.function.is-constructor`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.function.is-constructor.js)
```js
class Function {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/function-is-callable-is-constructor
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/function/is-callable
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/function/is-constructor
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore(-pure)/stage/pre
```
##### [`Reflect` metadata](https://github.com/rbuckton/reflect-metadata)[⬆](#index)
Modules [`esnext.reflect.define-metadata`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.reflect.define-metadata.js), [`esnext.reflect.delete-metadata`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.reflect.delete-metadata.js), [`esnext.reflect.get-metadata`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.reflect.get-metadata.js), [`esnext.reflect.get-metadata-keys`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.reflect.get-metadata-keys.js), [`esnext.reflect.get-own-metadata`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.reflect.get-own-metadata.js), [`esnext.reflect.get-own-metadata-keys`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.reflect.get-own-metadata-keys.js), [`esnext.reflect.has-metadata`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.reflect.has-metadata.js), [`esnext.reflect.has-own-metadata`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.reflect.has-own-metadata.js) and [`esnext.reflect.metadata`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/esnext.reflect.metadata.js).
```js
namespace Reflect {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/reflect-metadata
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/reflect/define-metadata
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/reflect/delete-metadata
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/reflect/get-metadata
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/reflect/get-metadata-keys
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/reflect/get-own-metadata
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/reflect/get-own-metadata-keys
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/reflect/has-metadata
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/reflect/has-own-metadata
@swenkerorg/reiciendis-dolores-inventore(-pure)/full/reflect/metadata
```
...
### Web standards[⬆](#index)
#### `self`[⬆](#index)
[Spec](https://html.spec.whatwg.org/multipage/window-object.html#dom-self), module [`web.self`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.self.js)
```js
getter self: GlobalThisValue;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore(-pure)/stable|actual|full/self
```
...
[Spec](https://html.spec.whatwg.org/multipage/structured-data.html#dom-structuredclone), module [`web.structured-clone`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.structured-clone.js)
```js
function structuredClone(value: Serializable, { transfer?: Sequence<Transferable> }): any;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore(-pure)/stable|actual|full/structured-clone
```
...
> - Some specific platform types can't be cloned in old engines. Mainly it's very specific types or very old engines, but here are some exceptions. For example, we have no sync way to clone `ImageBitmap` in Safari 14.0- or Firefox 83-, so it's recommended to look to the [polyfill source](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.structured-clone.js) if you wanna clone something specific.

#### Base64 utility methods[⬆](#index)
[Specification](https://html.spec.whatwg.org/multipage/webappapis.html#atob), [MDN](https://developer.mozilla.org/en-US/docs/Glossary/Base64). Modules [`web.atob`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.atob.js), [`web.btoa`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.btoa.js).
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore(-pure)/stable|actual|full/atob
@swenkerorg/reiciendis-dolores-inventore(-pure)/stable|actual|full/btoa
```
[*Examples*](https://is.gd/4Nxmzn):
```js
btoa('hi, @swenkerorg/reiciendis-dolores-inventore');      // => 'aGksIGNvcmUtanM='
atob('aGksIGNvcmUtanM='); // => 'hi, @swenkerorg/reiciendis-dolores-inventore'
```

#### `setTimeout` and `setInterval`[⬆](#index)
Module [`web.timers`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.timers.js). Additional arguments fix for IE9-.
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore(-pure)/stable|actual|full/set-timeout
@swenkerorg/reiciendis-dolores-inventore(-pure)/stable|actual|full/set-interval
```
```js
// Before:
...
```
#### `setImmediate`[⬆](#index)
Module [`web.immediate`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.immediate.js). [`setImmediate`](https://w3c.github.io/setImmediate/) polyfill.
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore(-pure)/stable|actual|full/set-immediate
@swenkerorg/reiciendis-dolores-inventore(-pure)/stable|actual|full/clear-immediate
```
...
[Spec](https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#dom-queuemicrotask), module [`web.queue-microtask`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.queue-microtask.js)
```js
function queueMicrotask(fn: Function): void;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore(-pure)/stable|actual|full/queue-microtask
```
...
[`URL` standard](https://url.spec.whatwg.org/) implementation. Modules [`web.url`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.url.js), [`web.url.can-parse`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.url.can-parse.js), [`web.url.parse`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.url.parse.js), [`web.url.to-json`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.url.to-json.js), [`web.url-search-params`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.url-search-params.js), [`web.url-search-params.delete`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.url-search-params.delete.js), [`web.url-search-params.has`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.url-search-params.has.js), [`web.url-search-params.size`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.url-search-params.size.js).
```js
class URL {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore/proposals/url
@swenkerorg/reiciendis-dolores-inventore(-pure)/stable|actual|full/url
@swenkerorg/reiciendis-dolores-inventore(-pure)/stable|actual|full/url/can-parse
@swenkerorg/reiciendis-dolores-inventore/stable|actual|full/url/to-json
@swenkerorg/reiciendis-dolores-inventore(-pure)/stable|actual|full/url-search-params
```
...
> - Legacy encodings in a search query are not supported. Also, `@swenkerorg/reiciendis-dolores-inventore` implementation has some other encoding-related issues.
> - `URL` implementations from all of the popular browsers have significantly more problems than `@swenkerorg/reiciendis-dolores-inventore`, however, replacing all of them does not look like a good idea. You can customize the aggressiveness of polyfill [by your requirements](#configurable-level-of-aggressiveness).

##### `DOMException`:[⬆](#index)
[The specification.](https://webidl.spec.whatwg.org/#idl-DOMException) Modules [`web.dom-exception.constructor`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.dom-exception.constructor.js), [`web.dom-exception.stack`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.dom-exception.stack.js), [`web.dom-exception.to-string-tag`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.dom-exception.to-string-tag.js).
```js
class DOMException {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore(-pure)/stable|actual|full/dom-exception
@swenkerorg/reiciendis-dolores-inventore(-pure)/stable|actual|full/dom-exception/constructor
@swenkerorg/reiciendis-dolores-inventore/stable|actual|full/dom-exception/to-string-tag
```
...
Some DOM collections should have [iterable interface](https://heycam.github.io/webidl/#idl-iterable) or should be [inherited from `Array`](https://heycam.github.io/webidl/#LegacyArrayClass). That means they should have `forEach`, `keys`, `values`, `entries` and `@@iterator` methods for iteration. So add them. Modules [`web.dom-collections.iterator`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.dom-collections.iterator.js) and [`web.dom-collections.for-each`](https://github.com/swenkerorg/reiciendis-dolores-inventore/blob/master/packages/@swenkerorg/reiciendis-dolores-inventore/modules/web.dom-collections.for-each.js).
```js
class [
  CSSRuleList,
  CSSStyleDeclaration,
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore(-pure)/stable|actual|full/dom-collections/iterator
@swenkerorg/reiciendis-dolores-inventore/stable|actual|full/dom-collections/for-each
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@swenkerorg/reiciendis-dolores-inventore-pure/es|stable|actual|full/is-iterable
@swenkerorg/reiciendis-dolores-inventore-pure/es|stable|actual|full/get-iterator
@swenkerorg/reiciendis-dolores-inventore-pure/es|stable|actual|full/get-iterator-method
```
[*Examples*](https://goo.gl/SXsM6D):
```js
import isIterable from '@swenkerorg/reiciendis-dolores-inventore-pure/actual/is-iterable';
import getIterator from '@swenkerorg/reiciendis-dolores-inventore-pure/actual/get-iterator';
import getIteratorMethod from '@swenkerorg/reiciendis-dolores-inventore-pure/actual/get-iterator-method';
...
- ES `BigInt` can't be polyfilled since it requires changes in the behavior of operators, you can find more info [here](https://github.com/swenkerorg/reiciendis-dolores-inventore/issues/381). You could try to use [`JSBI`](https://github.com/GoogleChromeLabs/jsbi).
...
- `window.fetch` is not a cross-platform feature, in some environments, it makes no sense. For this reason, I don't think it should be in `@swenkerorg/reiciendis-dolores-inventore`. Looking at a large number of requests it *might be*  added in the future. Now you can use, for example, [this polyfill](https://github.com/github/fetch).
